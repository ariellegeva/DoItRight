...
export default function HomePage() {
  ...
  const loadMissions = useCallback(() => {
    ...
    setLastWeekMissions(getLastWeekMissions())
  ...
  function handleKeepLastWeek() {
    ...
    replaceWeekMissions(weekOf, copied)
    loadMissions()
    // Open edit mode so they can tweak if needed
    setChatMode('edit')
    setChatOpen(true)
  }

  // ── New Week panel (Monday + no current missions) ─────────────────────────
